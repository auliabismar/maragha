...
<svelte:head>
	<title>Maragha - Tambah Kategori Baru</title>
	<meta name="description" content="Buat kategori baru untuk perpustakaan digital Maragha" />
</svelte:head>
...
<div class="container mx-auto max-w-2xl px-4 py-8">
	...
	>
		<div class="mb-6">
			<h1 class="mb-2 text-3xl font-bold text-[var(--foreground)]">Tambah Kategori Baru</h1>
			<p class="text-[var(--muted-foreground)]">
				Buat kategori baru untuk perpustakaan digital Maragha
			</p>
		</div>
		...
		>
			<!-- Nama Kategori -->
			<div>
				<label for="kategori" class="mb-2 block text-sm font-medium text-[var(--foreground)]">
					Nama Kategori <span class="text-[var(--destructive)]">*</span>
				</label>
				<input
					id="kategori"
					name="kategori"
